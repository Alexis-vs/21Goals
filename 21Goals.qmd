...
get_player_informations <- function(goal_link, season){
  ...
  extract = scraper$extract_table_from_url(goal_link, table_id = "stats_standard_dom_lg", image = "yes")
...
get_goals_by_rounds <- function(round_goal_link){
  ...
  extract <- scraper$extract_table_from_url(round_goal_link, table_id = "goallogs_goals")
  df_goals <- extract[[1]] %>%
